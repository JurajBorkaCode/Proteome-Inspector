class Compound:
    def __init__(self,Name,Recomended_Name,p_value,Cellular_Component,Molecular_Function,Biological_Process,Abundance,web,consume,produce,reaction,protein_name,unique):
        self.name = Name
